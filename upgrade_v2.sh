...
echo "  • Learning layer - improves over time"
...
echo "  • Training tab - review and correct classifications"
echo "  • Mappings tab - view/edit learned term mappings"
echo "  • Stats show learning progress"
echo ""
